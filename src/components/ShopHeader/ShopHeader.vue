<template>
  <div class="shop-header">
    ...
    <div class="shop-content">
      ...
      <div class="header-content" @click="isShowBrief=true">
    ...
    <!--利用v-if的特性，只有info.supports存在时才创立这个标签，就不会出现报错-->
    <div class="shop-header-discounts" v-if="info.supports" @click="isShowActivity=true">
      <div class="discounts-left">
        <div class="activity" :class="supportTagColor[info.supports[0].type]">
          <span class="content-tag">
    ...
    <transition name="shop">
      ...
      <div class="brief-modal-cover" @click="isShowBrief=false"></div>
    </div>
    </transition>
    <transition name="shop">
      <div class="activity-sheet" v-show="isShowActivity">
        <div class="activity-sheet-content">
        <h2 class="activity-sheet-title">
          优惠活动</h2>
        <ul class="list">
          <li class="activity-item" v-for="(support, index) in info.supports" :key="index" :class="supportTagColor[support.type]">
            <span class="content-tag">
...
<script>
  ...
  export default {
    data () {
      return {
        // 记录活动的标签的颜色的类名，根据下标取
        supportTagColor: ['activity-green', 'activity-red', 'activity-orange'],
        // 标记商家简介的显示隐藏
        isShowBrief: false,
        // 标记活动的显示隐藏
